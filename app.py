...
if not st.session_state.linkedin_logged_in:
    ...
    st.link_button("🔑 Login with LinkedIn", login_url)
    st.stop()

# ---------------------------------
# STEP 3: GENERATE POST & IMAGE
# ---------------------------------
st.divider()
st.subheader("📝 Generate LinkedIn Post & Image")
...
if st.button("Generate Post & Image"):
    with st.spinner("Generating content..."):
        ...
        img_prompt = generate_flux_image_prompt(post)
